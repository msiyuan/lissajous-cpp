...
void ImageProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->processingComplete((*reinterpret_cast< std::add_pointer_t<std::shared_ptr<ProcessingResult>>>(_a[1]))); break;
        ...
        {
            using _t = void (ImageProcessor::*)(std::shared_ptr<ProcessingResult> );
        ...
        {
            using _t = void (ImageProcessor::*)(const QString & );
            if (_t _q_method = &ImageProcessor::logMessage; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ImageProcessor::processingComplete(std::shared_ptr<ProcessingResult> _t1)
{
...
// SIGNAL 1
void ImageProcessor::logMessage(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
