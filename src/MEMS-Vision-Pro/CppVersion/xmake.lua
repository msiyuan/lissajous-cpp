...
target("dual-channel-tests")
    ...
    add_files("src/processing/MultiPhaseFrameBuffer.cpp")
    add_files("src/processing/MultiPhaseFusionProcessor.cpp")
    ...
    add_files("tests/ImageProtocolParsingTests.cpp")
    add_files("tests/FrameAssemblerTests.cpp")
    add_files("tests/MultiPhaseFrameBufferTests.cpp")
    add_files("tests/MultiPhaseFusionProcessorTests.cpp")
